...
export const examples: MrExample[] = [
  {
    ...
    description: 'Bind values with explicit types, then let the machine do the rest.',
    marathiDescription: 'स्पष्ट प्रकारांसह मूल्ये बांधा; पुढचे काम मशीन करू दे.',
    code: `// codepedia.io (@anvaymayekar)
...
leeh(username);                             // leeh() -> print()`,
  ...
  },
  {
    ...
    category: 'Foundations',
    description: 'The familiar arithmetic operators, expressed in Roman-script Marathi.',
    marathiDescription: 'Roman-script Marathi मध्ये ओळखीचे अंकगणिती संकारक.',
    code: `// codepedia.io (@anvaymayekar)
...
leeh(a % b);        // % -> modulo`,
  ...
  },
  {
    ...
    marathiDescription: 'मूल्यांची तुलना करून प्रोग्रामला थेट प्रश्न विचारा.',
    code: `// codepedia.io (@anvaymayekar)
...
leeh(a >= b);       // >= -> greater/equal`,
  ...
  },
  {
    ...
    category: 'Foundations',
    description: 'Combine truths with the small, readable vocabulary of .mr.',
    marathiDescription: 'सत्य मूल्ये .mr च्या छोट्या, वाचनीय शब्दसंग्रहाने जोडा.',
    code: `// codepedia.io (@anvaymayekar)
...
jar (temperature >= 40.0) {
  ...
  },
  {
    ...
    marathiDescription: 'ओळखीच्या संख्येइतक्या वेळा संक्षिप्त range सह पुन्हा करा.',
    code: `// codepedia.io (@anvaymayekar)
...
leeh(sum);`,
  ...
  },
  {
    ...
    category: 'Functions',
    description: 'Give a reusable idea a name and pass it the values it needs.',
    marathiDescription: 'पुन्हा वापरता येणाऱ्या कल्पनेला नाव द्या आणि मूल्ये पाठवा.',
    code: `// codepedia.io (@anvaymayekar)
...
greet("Anvay");`,
  ...
  },
  {
    ...
    marathiDescription: 'मुख्य संख्यात्मक प्रकारांनी व्यापलेली memory पाहा.',
    code: `// codepedia.io (@anvaymayekar)
...
leeh(large);`,
  ...
  },
  {
    ...
    marathiDescription: 'स्पष्ट exit code सह native process मधून बाहेर पडा.',
    code: `// codepedia.io (@anvaymayekar)
...
shevti(13);`,
  ...
  },
  {
    ...
    category: 'Planned',
    description: 'A branching form we are keeping visible while it is designed.',
    marathiDescription: 'डिझाइन सुरू असताना दिसत ठेवलेले branching रूप.',
    code: `// switch statement — planned
// ya udaharanavar ajun compile karta yet nahi`,
    output: '',
    status: 'planned',
    note: 'Planned, not executable yet.',
  },
];

export const readyExamples = examples.filter((example) => example.status === 'ready');

export function getExample(slug: string | null | undefined) {
  return examples.find((example) => example.slug === slug) ?? readyExamples[0];
}